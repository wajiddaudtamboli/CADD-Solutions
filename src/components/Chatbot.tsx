...
const Chatbot = () => {
  ...
  return <>
      ...
      {/* Chat Window */}
      <AnimatePresence>
        {isOpen && <motion.div className="fixed bottom-24 right-6 z-40 w-80 sm:w-96" initial={{
        opacity: 0,
        y: 20,
        scale: 0.8
      }} animate={{
            ...
            <Card className="shadow-2xl border-0 overflow-hidden">
              ...
              <CardContent className="p-0">
                ...
                y: 0
                      ...
                      {message.isBot && <div className="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center flex-shrink-0">
                          <Bot size={16} className="text-white" />
                        </div>}
                      
                      <div className={`max-w-xs p-3 rounded-lg ${message.isBot ? 'bg-white text-gray-800 shadow-sm' : 'bg-blue-600 text-white'}`}>
                        <p className="text-sm whitespace-pre-line">{message.text}</p>
                      </div>
                      
                      {!message.isBot && <div className="w-8 h-8 bg-gray-600 rounded-full flex items-center justify-center flex-shrink-0">
