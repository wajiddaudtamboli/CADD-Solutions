...
const EnhancedServices = () => {
  ...
  const ServiceCard = ({ service, index }: { service: any; index: number }) => (
    ...
    >
      <a
        ...
        className="block bg-white dark:bg-red-900/90 rounded-xl p-6 text-center shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-transparent hover:border-red-500 dark:hover:border-red-400"
      >
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 via-red-50 to-pink-50 dark:from-red-900 dark:via-red-800 dark:to-red-700 transition-colors duration-300">
      ...
      <section id="software-courses" className="py-20 bg-white/50 dark:bg-red-800/50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-red-200">Master programming languages & data science</p>
          </motion.div>
