...
const Hero = () => {
  ...
  return <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-red-950 via-red-900 to-rose-950">
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute inset-0">
          {[...Array(20)].map((_, i) => <motion.div key={i} className="absolute w-1 h-1 bg-red-300 rounded-full opacity-70" style={{
      ...
      y,
      color
    }, index) => <motion.div key={index} className="absolute hidden lg:block" style={{
      left: `${15 + index * 12}%`,
      top: `${25 + index * 8}%`
    }} initial={{
      opacity: 0,
      ...
      <div className="professional-container relative z-10 grid lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto px-6">
        {/* Left Content */}
        <motion.div className="professional-spacing text-center lg:text-left" initial={{
        opacity: 0,
        x: -50
      }} animate={{
        opacity: 1,
        ...
        duration: 0.8
          ...
          <motion.div className="inline-flex items-center gap-2 bg-gradient-to-r from-red-500/20 to-rose-500/20 backdrop-blur-sm rounded-full px-6 py-3 mb-8 border border-red-400/30" initial={{
          scale: 0
        }} animate={{
          scale: 1
        }} transition={{
          ...
          <motion.h1 className="text-5xl lg:text-7xl font-bold mb-8 text-left lg:text-left leading-tight" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          delay: 0.3
            ...
            <span className="relative bg-gradient-to-r from-red-300 via-red-200 to-rose-300 bg-clip-text text-transparent">
              CAD & Engineering
              <motion.div className="absolute -bottom-2 left-0 w-full h-1 bg-gradient-to-r from-red-400 to-rose-400 rounded-full" initial={{
              scaleX: 0
            }} animate={{
              scaleX: 1
            }} transition={{
          ...
          <motion.p className="text-xl text-red-100/90 leading-relaxed text-left max-w-2xl mb-10" initial={{
          opacity: 0,
          y: 20
        }} animate={{
          opacity: 1,
          ...
          <motion.div className="grid grid-cols-3 gap-8 pt-16 text-center lg:text-left" initial={{
          opacity: 0
        }} animate={{
          opacity: 1
        }} transition={{
        ...
        delay: 0.3
          ...
          <motion.div className="relative max-w-md w-full" whileHover={{
          scale: 1.05
        }} transition={{
          type: "spring",
          stiffness: 300
            ...
            <div className="relative bg-gradient-to-br from-red-800/50 to-red-900/50 backdrop-blur-sm rounded-2xl p-1 border border-red-400/30 shadow-2xl shadow-red-500/20">
              <video className="w-full h-auto object-cover rounded-xl" autoPlay muted loop playsInline>
                <source src="/imgs/portfolio/watermark.mp4" type="video/mp4" />
              </video>
              
              {/* Enhanced Overlay */}
              <motion.div className="absolute inset-0 bg-gradient-to-t from-red-900/40 via-transparent to-red-800/20 rounded-xl pointer-events-none" initial={{
              opacity: 0
            }} animate={{
              opacity: 1
            }} transition={{
      ...
      delay: 1.5
        ...
        <motion.div className="w-6 h-10 border-2 border-red-300 rounded-full flex justify-center backdrop-blur-sm bg-red-500/10" animate={{
        y: [0, 10, 0]
      }} transition={{
        duration: 2,
        repeat: Infinity
      }}>
          <motion.div className="w-1 h-2 bg-red-300 rounded-full mt-2" animate={{
          opacity: [1, 0, 1]
        }} transition={{
          duration: 2,
          repeat: Infinity
