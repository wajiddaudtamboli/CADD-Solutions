...
const FAQ = () => {
  ...
  return (
    <section className="py-12 sm:py-16 bg-gradient-to-br from-gray-50 via-yellow-50 to-amber-50 dark:from-gray-900 dark:via-yellow-900 dark:to-amber-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto px-3 sm:px-4">
              ...
              <Card className="border border-gray-200 dark:border-gray-700 hover:border-yellow-300 dark:hover:border-yellow-500 transition-all duration-300 bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm">
                <CardContent className="p-0">
                  <button 
                    ...
                    className="w-full p-3 text-left flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-200 rounded-lg"
                  >
                    <h3 className="text-sm sm:text-base font-semibold text-gray-800 dark:text-white pr-3 leading-tight">
                      {item.question}
                    </h3>
                    {openItems.includes(index) ? 
                      <ChevronUp className="w-4 h-4 text-yellow-600 dark:text-yellow-400 flex-shrink-0" /> : 
                      <ChevronDown className="w-4 h-4 text-yellow-600 dark:text-yellow-400 flex-shrink-0" />
                    }
                  </button>
        ...
        >
          <Card className="bg-gradient-to-r from-yellow-500 to-yellow-600 text-white max-w-2xl mx-auto">
            <CardContent className="p-4 sm:p-6">
              <h3 className="text-lg sm:text-xl font-bold mb-3 text-center">Still have questions?</h3>
              <p className="text-yellow-100 mb-4 sm:mb-6 text-sm text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center">
                <a 
                  ...
                  className="bg-white text-yellow-700 px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors duration-200 text-center text-sm"
                >
                  📞 Call Us: +91 96890 44025
                </a>
                <a 
                  href="mailto:tambolimahibub@gmail.com" 
                  className="bg-white/20 backdrop-blur-sm border-2 border-white/30 text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg font-semibold hover:bg-white/30 transition-colors duration-200 text-center text-sm"
                >
                  ✉️ Email Us
                </a>
              </div>
