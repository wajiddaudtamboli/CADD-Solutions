...
const Navigation = () => {
  ...
  return (
    <motion.nav 
      className="fixed top-0 left-0 right-0 z-50 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-b border-gray-200/30 dark:border-gray-700/30 transition-all duration-300" 
      style={{
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 h-full relative">
        ...
        >
          ...
          <motion.button
            ...
            className="fixed top-3 right-3 z-[60] w-10 h-10 bg-white/90 dark:bg-gray-900/90 backdrop-blur-lg rounded-lg shadow-lg border border-gray-200/50 dark:border-gray-700/50 flex items-center justify-center hover:scale-105 transition-all duration-300"
            style={{ 
          ...
          <motion.div 
            className="fixed inset-x-3 z-[50] bg-white/98 dark:bg-gray-900/98 backdrop-blur-xl rounded-xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 overflow-hidden max-w-xs mx-auto"
            style={{ 
            ...
            <div className="p-3 space-y-1">
              {navItems.map((item, index) => (
                <motion.button 
                  ...
                  className="w-full text-left px-3 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-primary/10 hover:text-primary font-medium transition-all duration-300 flex items-center space-x-2 active:scale-95 text-sm"
            ...
            <div className="border-t border-gray-200 dark:border-gray-700 p-3">
              <div className="flex items-center justify-center space-x-2">
                <Button 
                  ...
                  className="text-gray-600 dark:text-gray-400 hover:text-primary p-1.5 rounded-lg h-8 w-8"
                >
                  <Shield size={14} />
                </Button>
                <ThemeToggle />
