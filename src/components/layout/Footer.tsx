      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold">CADD Solutions</span>
            </div>
            <p className="text-gray-300">
              Professional training institute for CAD, CAE, Programming, and Engineering design courses.
            </p>
          ...
          >
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#products" className="text-gray-300 hover:text-white transition-colors">Courses</a></li>
        ...
        >
          <p className="text-gray-400">
            © 2024 CADD Solutions. All rights reserved. | Designed with ❤️ for engineering excellence
          </p>
        </motion.div>
      </div>
    </footer>
